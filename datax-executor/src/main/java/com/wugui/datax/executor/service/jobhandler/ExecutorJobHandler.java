...
public class ExecutorJobHandler extends IJobHandler {
    ...
    public ReturnT<String> execute(TriggerParam trigger) {
        ...
        JobLogger.log("------------------生成json文件；");
        JobLogger.log("------------------jobJson：" + jobJson);
        ...
        try {
            ...
            JobLogger.log("------------------cmdarrayFinal：" + Arrays.toString(cmdarrayFinal));

            /* cmdarrayFinalStr */
            StringBuilder sb = new StringBuilder();
            for (String str : cmdarrayFinal) {
                sb.append(str).append(" ");
            }
            String cmdarrayFinalStr = sb.toString().trim();
            JobLogger.log("------------------cmdarrayFinalStr：" + cmdarrayFinalStr);

            final Process process = Runtime.getRuntime().exec(cmdarrayFinalStr);
    ...
    private String  generateTemJsonFile(String jobJson) {
        ...
        JobLogger.log("tmpFilePath：" + tmpFilePath);
